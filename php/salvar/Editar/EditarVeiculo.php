...
if(isset($_SESSION['sucesso_cadastro'])){
    ...
    <form method="POST" action="../../salvar/Atualizar/AtualizarVeiculo.php">
        ...
        <fieldset><label for="Ano">Ano</label><input type="text" name="Ano" id="Ano"  value="<?php echo $carro['ano_car']; ?>" maxlength="4" required></fieldset>
        <fieldset><label for="Preco">Preço</label><input type="text" name="Preco" id="Preco"  value="<?php echo $carro['preco_car']; ?>" maxlength="20" required></fieldset>
        ...
        <fieldset><label for="Quilometragem">Quilometragem</label><input type="text" name="Quilometragem" id="Quilometragem"  value="<?php echo $carro['quilometragem_car']; ?>" maxlength="20" required></fieldset>
